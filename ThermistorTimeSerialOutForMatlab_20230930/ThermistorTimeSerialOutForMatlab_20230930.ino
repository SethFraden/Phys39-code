...
// The thermistor is a Epcos, R/T 2014 with R_25 = 100,000 ohms. B-parameter equation given in code.
// Outputs temperature (C), elapsed time (s) and PWM (0-255)
// Example serial line output:
//              Temperature (C): 21.13, Time (s): 13.89, Heat/Cool: 1, PWM: 129


// Works with Matlab app "testappV3"
// Matlab reads and plots the results in a stripchart
// Matlab sets pwmValue between [0,255] and passes value to Arduino via Serial
// Arduino code uses the pwmValue to control H-bridge
