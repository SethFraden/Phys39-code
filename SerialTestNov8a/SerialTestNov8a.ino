    //Works! November 8, 2023

    // There are 6 thermistors. The UNO has 6 analog input pins, so all are used.
    // The one called "temp" is located just next to the TEC and is used for PID control
    // The other 5, T1, T2, T3, T4, T5 are located along the rod for measuring temperature.
    ...
    // Sends output of 12 values to Matlab as a ArduinoParams class:  
    // ArduinoParams ARDparams[temp, time, pwmNow, HeatCool, error, Integral, Tset, T1, T2, T3, T4, T5] with formats [%f, %f, %d, %d, %f, %f, %f, %f, %f, %f, %f, %f]
...
void loop() {
 ...
 float T1 = measureTemperature(tempIn1, 1000); // Measure thermistor at A1 pin
 float T2 = measureTemperature(tempIn2, 1000); // Measure thermistor at A2 pin
 float T3 = measureTemperature(tempIn3, 1000); // Measure thermistor at A3 pin
 float T4 = measureTemperature(tempIn4, 1000); // Measure thermistor at A4 pin
 float T5 = measureTemperature(tempIn5, 1000); // Measure thermistor at A5 pin
...
// Send the 12 ARDparams (temperature, time, PWM, heat/cool, error, integral, Tset, T1, T2, T3, T4, T5) to Matlab for plotting
